...
def create_families_file(directory, basepath, output_file):
    ...
    for family_number, file in files_info:
        ...
        absolute_path = os.path.join(basepath, file_path)
...
create_families_file(directory, basepath, output_file)
